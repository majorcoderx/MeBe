...
namespace MeBe
{
    ...
    public sealed partial class App : Application
    {
        ...
        public async Task<bool> DoesFileExistAsync(string file)
        {
            try
            {
        ...
        {
            if (!DoesFileExistAsync("Data.sqlite").Result)
            {
                string databaseFile = Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, @"Data.sqlite");
